 ...
 * BUG FIX: field name was 'file' — changed to 'challanPhotoUpload' to match
 * the frontend FormData key and the Mongoose schema field.
 */
const uploadImage = (req, res, next) => {
  // BUG FIX: was upload.single('file') — req.file was always undefined
  ...
  handler(req, res, (err) => {
    ...
    if (err.code === 'LIMIT_FILE_SIZE') {
      ...
      err.statusCode = 422;
      err.message = 'Unexpected field name — use "challanPhotoUpload" as the field key.';
    }
