...
router.post('/:taskId/fabricator/init', uploadImage, initFabricatorController);
router.post('/:taskId/fabricator/receiving', uploadImage, addFabricatorReceivingController);
